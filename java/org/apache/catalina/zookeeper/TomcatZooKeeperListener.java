 ...
 *
 */
public class TomcatZooKeeperListener implements Watcher {

    private static final Log logger = LogFactory.getLog(TomcatZooKeeperListener.class);

    protected CountDownLatch countDownLatch = null;

    public static ZooKeeper zooKeeper = null;

    public TomcatZooKeeperListener(int count){
     ...
     */
    public void connect(String hosts, int timeOut){
        try {
            if(zooKeeper == null){
